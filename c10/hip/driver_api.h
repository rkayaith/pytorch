...
#define C10_LIBCUDA_DRIVER_API_REQUIRED(_)         \
  _(hipDeviceGet, 12000)                            \
  _(hipDeviceGetAttribute, 12000)                   \
  _(hipMemGetAddressRange, 12000)                   \
  ...
  _(hipMemRetainAllocationHandle, 12000)            \
  _(hipMemGetAllocationPropertiesFromHandle, 12000) \
...
#elif defined(TORCH_HIP_VERSION) && (TORCH_HIP_VERSION >= 12030)
#define C10_LIBCUDA_DRIVER_API_OPTIONAL(_) \
  _(cuMulticastAddDevice, 12030)           \
  _(cuMulticastBindMem, 12030)             \
  _(cuMulticastCreate, 12030)              \
