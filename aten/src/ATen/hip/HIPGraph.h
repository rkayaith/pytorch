...
#endif // defined(USE_ROCM) || !(defined(TORCH_HIP_VERSION) && TORCH_HIP_VERSION >= 12040)
...
struct TORCH_CUDA_CPP_API CUDAGraph {
 ...
 private:
  ...
  std::function<bool(hipStream_t)> create_child_allocate_filter();
 ...
 protected:
  ...
  bool keep_graph_;
  hipStreamCaptureMode capture_mode_{};
