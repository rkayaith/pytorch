...
TORCH_CUDA_CPP_API hipDeviceProp_t* getDeviceProperties(c10::DeviceIndex device);
...
TORCH_CUDA_CPP_API hipblasHandle_t getCurrentCUDABlasHandle(bool setup = true);
TORCH_CUDA_CPP_API hipblasLtHandle_t getCurrentCUDABlasLtHandle();

TORCH_CUDA_CPP_API void clearCublasWorkspaces();
TORCH_CUDA_CPP_API void clearCublasWorkspacesForStream(hipStream_t stream);
