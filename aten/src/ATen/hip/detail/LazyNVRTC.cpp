...
static std::string getLibVersion() {
  ...
  constexpr auto major = TORCH_HIP_VERSION / 1000;
  constexpr auto minor = ( TORCH_HIP_VERSION / 10 ) % 10;
#if defined(_WIN32)
...
NVRTC_STUB2(hiprtcGetBitcodeSize, hiprtcProgram, size_t *)
NVRTC_STUB2(hiprtcGetBitcode, hiprtcProgram, char *)
...
CUDA_STUB2(hipModuleLoad, hipModule_t*, const char*)
CUDA_STUB2(hipModuleLoadData, hipModule_t *, const void *)
CUDA_STUB2(hipFuncSetCacheConfig, hipFunction_t, hipFuncCache)
CUDA_STUB3(hipDeviceGetAttribute, int*, hipDeviceAttribute_t, hipDevice_t)
CUDA_STUB2(hipDeviceGet, hipDevice_t*, int)
...
CUDA_STUB2(hipDrvGetErrorString, hipError_t, const char **)
CUDA_STUB1(hipCtxGetCurrent, hipCtx_t *)
CUDA_STUB1(hipCtxSetCurrent, hipCtx_t)
CUDA_STUB1(hipModuleUnload, hipModule_t)
CUDA_STUB3(hipDevicePrimaryCtxGetState, hipDevice_t, unsigned int *, int *)
CUDA_STUB2(hipDevicePrimaryCtxRetain, hipCtx_t *, hipDevice_t)
CUDA_STUB4(hipLinkCreate, unsigned int, hipJitOption *, void **, CUlinkState *)
CUDA_STUB3(hipLinkComplete, CUlinkState, void **, size_t *)
CUDA_STUB3(hipFuncSetAttribute, hipFunction_t, hipFuncAttribute_t, int)
CUDA_STUB3(hipFuncGetAttribute, int*, hipFuncAttribute_t, hipFunction_t)
CUDA_STUB3(hipPointerGetAttribute, void*, hipPointer_attribute, hipDeviceptr_t)
...
// Irregularly shaped functions
hipError_t CUDAAPI hipModuleLaunchCooperativeKernel(
    hipFunction_t f,
    unsigned int gridDimX,
    unsigned int gridDimY,
    unsigned int gridDimZ,
    ...
    hipStream_t hStream,
    void** kernelParams) {
  auto fn = reinterpret_cast<decltype(&hipModuleLaunchCooperativeKernel)>(
      getCUDALibrary().sym(__func__));
  if (!fn)
    throw std::runtime_error("Can't get hipModuleLaunchCooperativeKernel");
  lazyNVRTC.hipModuleLaunchCooperativeKernel = fn;
  return fn(
      f,
      gridDimX,
      gridDimY,
