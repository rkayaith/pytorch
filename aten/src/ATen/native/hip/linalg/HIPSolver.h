...
#define CUDASOLVER_GETRS_ARGTYPES(Dtype)  \
    hipsolverDnHandle_t handle, int n, int nrhs, Dtype* dA, int lda, int* ipiv, Dtype* ret, int ldb, int* info, hipblasOperation_t trans
...
#define CUDASOLVER_SYTRF_ARGTYPES(Dtype)                                      \
  hipsolverDnHandle_t handle, hipblasFillMode_t uplo, int n, Dtype *A, int lda, \
...
#define CUDASOLVER_POTRF_ARGTYPES(Dtype)  \
    hipsolverDnHandle_t handle, hipblasFillMode_t uplo, int n, Dtype* A, int lda, Dtype* work, int lwork, int* info
...
#define CUDASOLVER_POTRF_BUFFERSIZE_ARGTYPES(Dtype)  \
    hipsolverDnHandle_t handle, hipblasFillMode_t uplo, int n, Dtype* A, int lda, int* lwork
...
#define CUDASOLVER_POTRF_BATCHED_ARGTYPES(Dtype)  \
    hipsolverDnHandle_t handle, hipblasFillMode_t uplo, int n, Dtype** A, int lda, int* info, int batchSize
...
#define CUDASOLVER_POTRS_ARGTYPES(Dtype)  \
    hipsolverDnHandle_t handle, hipblasFillMode_t uplo, int n, int nrhs, const Dtype *A, int lda, Dtype *B, int ldb, int *devInfo
...
#define CUDASOLVER_POTRS_BATCHED_ARGTYPES(Dtype)  \
    hipsolverDnHandle_t handle, hipblasFillMode_t uplo, int n, int nrhs, Dtype *Aarray[], int lda, Dtype *Barray[], int ldb, int *info, int batchSize
...
#define CUDASOLVER_ORMQR_BUFFERSIZE_ARGTYPES(Dtype)                          \
  hipsolverDnHandle_t handle, hipblasSideMode_t side, hipblasOperation_t trans, \
...
#define CUDASOLVER_SYEVD_BUFFERSIZE_ARGTYPES(scalar_t, value_t)             \
  hipsolverDnHandle_t handle, hipsolverEigMode_t jobz, hipblasFillMode_t uplo, \
...
#define CUDASOLVER_XSYEVD_ARGTYPES(scalar_t, value_t)                        \
  hipsolverDnHandle_t handle, hipsolverDnParams_t params,                      \
      hipsolverEigMode_t jobz, hipblasFillMode_t uplo, int64_t n, scalar_t *A, \
