  ...
  if (B.size(-1) == 1) {
    AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES(
        X.scalar_type(), "triangular_solve_out_sparse_csr_cuda_impl", [&] {
          ...
          TORCH_CUDASPARSE_CHECK(hipsparseSpSV_bufferSize(
              handle,
              opA,
              &alpha,
              descA.descriptor(),
          ...
          TORCH_CUDASPARSE_CHECK(hipsparseSpSV_analysis(
              handle,
              opA,
              &alpha,
              descA.descriptor(),
          ...
          TORCH_CUDASPARSE_CHECK(hipsparseSpSV_solve(
              handle,
              opA,
              &alpha,
              descA.descriptor(),
...
#define ROCM_EXTRA_ARG
    ...
    AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES(
        X.scalar_type(), "triangular_solve_out_sparse_csr_cuda_impl", [&] {
          ...
          TORCH_CUDASPARSE_CHECK(hipsparseSpSM_bufferSize(
              handle,
              opA,
              opB,
              &alpha,
          ...
          TORCH_CUDASPARSE_CHECK(hipsparseSpSM_analysis(
              handle,
              opA,
              opB,
              &alpha,
          ...
          TORCH_CUDASPARSE_CHECK(hipsparseSpSM_solve(
              handle,
              opA,
              opB,
              &alpha,
